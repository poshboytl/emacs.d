 ...
 (mapcar
  ...
  `(
    ...
    (:name sass-mode :url bundle :lazy t
           :build `(,(concat el-get-emacs " -batch -q -no-site-file -L . -L ../haml-mode --eval '(byte-compile-file \"sass-mode.el\")'")))
    ...
    (:name highlight-parentheses :lazy t)
    (:name hide-comnt :type emacswiki)
    (:name thingatpt+ :type emacswiki)
    (:name thing-cmds :type emacswiki)
