(custom-set-variables
 ...
 '(auto-save-list-file-prefix "~/.emacs.d/data/.autosaves-")
 ...
 '(bmkp-bmenu-commands-file "~/.emacs.d/data/bmkp-commands.el")
 '(bmkp-bmenu-state-file "~/.emacs.d/data/bmkp-state.el")
 ...
 '(desktop-path (quote ("." "~/.emacs.d/data")))
 ...
 '(ede-project-placeholder-cache-file (expand-file-name "~/.emacs.d/data/.projects.ede"))
 ...
 '(gnus-init-file "~/.emacs.d/config/iy-gnus")
 '(gnus-startup-file "~/.emacs.d/data/newsrc")
 ...
 '(ido-slow-ftp-hosts (quote ("izenesoft.com")))
 '(ido-use-filename-at-point nil)
 '(ido-work-directory-list-ignore-regexps (quote ("^/[^:]*@izenesoft.com:" "^/scp:" "^/ssh:")))
...
")
 ...
 '(user-mail-address "doit.ian@gmail.com")
